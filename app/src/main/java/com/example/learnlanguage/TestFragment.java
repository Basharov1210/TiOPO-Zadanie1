...
public class TestFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_topic_test,container,false);
       btnEnd = view.findViewById(R.id.btnEnd);
       btnEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), TopicActivity.class);
                intent.putExtra(TopicActivity.TOPIC_CODE,topic);
            ...
            buttonAnswer1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (buttonAnswer1.getText().equals(words.get(position).TrueWord)) {
                        ...
                        next.exitTest();
                        Toast.makeText(getActivity(),"Ответ неверный. Подучите слова!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
